...
actual class PlatformVpnEngine : io.nikdmitryuk.ultraclient.domain.vpn.VpnEngine {
    ...
    actual override suspend fun connect(config: VlessConfig, antiDetect: AntiDetectConfig): Result<Unit> =
        Result.failure(UnsupportedOperationException("JVM target is for testing only"))
